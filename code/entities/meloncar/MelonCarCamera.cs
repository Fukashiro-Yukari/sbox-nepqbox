...
public class MelonCarCamera : Camera
{
	...
	public override void Activated()
	{
		...
		var car = (pawn as SandboxPlayer)?.Vehicle as MelonCarEntity;
	...
	private void DoThirdPerson( MelonCarEntity car, PhysicsBody body )
	{
