...
[Library( "ent_meloncar", Title = "Melon Car", Spawnable = true )]
public partial class MelonCarEntity : Prop, IUse
{
	...
	private MelonCarWheel frontLeft;
	private MelonCarWheel frontRight;
	private MelonCarWheel backLeft;
	private MelonCarWheel backRight;
	...
	public MelonCarEntity()
	{
		frontLeft = new MelonCarWheel( this );
		frontRight = new MelonCarWheel( this );
		backLeft = new MelonCarWheel( this );
		backRight = new MelonCarWheel( this );
	}
	...
	public bool OnUse( Entity user )
	{
		...
		{
			player.Vehicle = this;
			player.VehicleController = new MelonCarController();
			player.VehicleAnimator = new CarAnimator();
			player.VehicleCamera = new MelonCarCamera();
			player.Parent = this;
